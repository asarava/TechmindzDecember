...
public class HomePage extends TestBase {
	...
	public void EnterMail(String Value) {
	 ...
	 public boolean NameOfUser(){
		 objWrapper.wait(driver, nameofuser);
		 return nameofuser.isDisplayed();		 
	 }
	 public boolean Logout(){
		 objWrapper.wait(driver, logout);
		 return logout.isDisplayed();		 
	 }
	 public boolean cartValidation() {
		 objWrapper.wait(driver,placeorder);
		 return placeorder.isDisplayed();
	 }
	 public void AddProduct() {
		 objWrapper.wait(driver, product);
		 product.click();
		 objWrapper.wait(driver, addtoCart);
		 addtoCart.click();
		 objWrapper.waitforalert(driver);
	 }
	 public void DeleteProduct() {
		 objWrapper.wait(driver, delete);
		 delete.click();
	 }
